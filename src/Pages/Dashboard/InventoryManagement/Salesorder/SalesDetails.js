...
const SalesDetails = ({ backToList }) => {
  ...
  return (
    <div>
      ...
      <FormControlLabel className="pdf-switch" control={<Switch defaultChecked />} labelPlacement="end" 
      style={{ width: '98%'}}  sx={{
      ...
      <div className="create-invoice-outer-card">
        ...
        <div className="sales-invoice">
            ...
            <div className="fw-bold">Sales Order<span className="draft-text">Draft</span></div>
