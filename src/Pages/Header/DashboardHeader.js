...
import { clearAuthState, logout } from "../../Redux/auth/authSlice";
...
const DashboardHeader = () => {
  ...
  const handleAccount = () => {
    navigate("/admin/authentication", { state: { data } });
    dispatch(logout());
  };
        ...
        <div className="right-drawer">
          <div className="account-profile">
            ...
            <div>
              ...
              <p className="text-secondary">{data?.data?.user?.emailId}</p>
            </div>
          </div>
          <p>User Id: {data?.data?.user?._id}</p>
        </div>
        <hr className="m-0" />
        <div className="right-drawer">
          ...
          <div className="account-profile">
            ...
            <div>
              <p>{data?.data?.user?.companyName}</p>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="ms-auto dashboard-group">
              ...
              <div className="notification-profile">
                ...
                <div>
                  Hello {data?.data?.user?.firstName}{" "}
